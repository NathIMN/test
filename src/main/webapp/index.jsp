...
<head>
    ...
    <style>
        /* Combined hero and search background section */
        .hero-search-bg {
            position: relative;
        ...
        /* Overlay for hero section (darker) */
        .hero-overlay {
            position: relative;
        }
        ...
        /* Overlay for search section (lighter) */
        .search-overlay {
            position: relative;
        }
        ...
        .hero-search-bg .hero-section {
            margin-bottom: 0;
            padding-bottom: 2rem; /* Reduced padding */
        }
        
        .hero-search-bg .search-section {
            margin-top: 0;
...
<body>
    ...
    <div class="hero-search-bg">
        <!-- Hero Section -->
        <section class="hero-section py-5 hero-overlay text-white">
        ...
        <!-- Search Bar Section -->
        <section class="search-section py-5 search-overlay">
            <div class="container">
    ...
    <section class="py-5 bg-gray">
	  <div class="container">
	    ...
	    <div class="row justify-content-center">
	      <div class="col-lg-10">
	        <div class="d-flex flex-wrap justify-content-center align-items-center gap-5 text-center">
	          <div class="text-primary">
	            <i class="fas fa-cogs fa-3x mb-3"></i>
	            <div class="fw-semibold fs-5">AutoParts Co.</div>
	          </div>
	          <div class="text-primary">
	            <i class="fas fa-truck-moving fa-3x mb-3"></i>
	            <div class="fw-semibold fs-5">QuickMove</div>
	          </div>
	          <div class="text-primary">
	            <i class="fas fa-tools fa-3x mb-3"></i>
	            <div class="fw-semibold fs-5">FixRight</div>
	          </div>
	          <div class="text-primary">
	            <i class="fas fa-warehouse fa-3x mb-3"></i>
	            <div class="fw-semibold fs-5">StoreHub</div>
	          </div>
	          <div class="text-primary">
	            <i class="fas fa-industry fa-3x mb-3"></i>
	            <div class="fw-semibold fs-5">BuildCore</div>
	          </div>
	        </div>
	      </div>
	    </div>
