            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <%if(!"admin".equals(user)){%>
	                    <li class="nav-item">
	                        <a class="nav-link active" href="<%= request.getContextPath() %>/IndexSrv">Home</a>
	                    </li>
	                    <li class="nav-item">
	                       	<a class="nav-link" href="<%= request.getContextPath() %>/Inquiry/inquiryInsert.jsp">Support</a>
	                   	</li>
	                   	<li class="nav-item">
	                        <a class="nav-link" href="<%= request.getContextPath() %>/aboutUs.jsp">About Us</a>
	                    </li>
                    <% } %> 
                    <%if("admin".equals(user)){%>
                    	<li class="nav-item">
                        	<a class="nav-link" href="#">Parts Catalog</a>
                    	</li>
                    <% } %>
                    <%if("admin".equals(user)){%>
                    	<li class="nav-item">
                        	<a class="nav-link" href="<%= request.getContextPath() %>/CreateItem">Add Item</a>
                    	</li>
                    <% } %> 
                    <%if("supplier".equals(user)){%>
                    	<li class="nav-item">
                        	<a class="nav-link" href="<%= request.getContextPath() %>/SupplierGetRegisteredItems">Restock Requests</a>
                    	</li>
                    <% } %> 
